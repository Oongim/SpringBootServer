...
public class AuthController {
    ...
    public ResponseEntity<TokenDto> authorize(@Valid @RequestBody LoginUserDto loginDto){
        UsernamePasswordAuthenticationToken authenticationToken =
        new UsernamePasswordAuthenticationToken(loginDto.getEmail(), loginDto.getUuid());
